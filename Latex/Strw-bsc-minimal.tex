...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{electronic energy levels + spectrum}
    \caption{Caption}
    \label{fig:enter-label}
\end{figure}

Last, there are vibrational transitions. This changes the vibration and rotation of the molecule. IR

\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{vibrational energy levels + spectrum}
    \caption{Caption}
    \label{fig:enter-label}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{Rotational energy levels + spectrum}
    \caption{Caption}
    \label{fig:enter-label}
\end{figure}
...
\begin{figure}[!ht]
    ...
    \caption{The total flux of HCN, NO, and NH\3 for all the models in the grid.}
    \label{fig: Heatmaps2}
\end{figure}
...
When we applied this method to the fiducial model and model C+0.25 O-0.25, we got the detections shown in \autoref{tab: fiducial detection} and \autoref{tab: other detection} respectively. 
...
\caption{Molecular detections in Spectrum A and B before and after subtracting modeled molecular emission. A confirmed detection (\ding{51}) indicates that the molecule is detected in the full spectrum but disappears in the residual.}
