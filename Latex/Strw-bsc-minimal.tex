...
\textbf{Gravitational instability}

\subsection{Disk Dispersion}
\textbf{PHOTO-EVAPORATION}


\subsection{Substructures}
\textbf{gaps}
\textbf{dust to planet}
...
To produce an estimate on the upper limit
\textbf{EXPLANATION ON THE UPPER LIMITS}
...
\begin{tabular}{lll}
\hline
Source   & NO   & NH\3 \\ \hline
GWLup    & 16.5 & 21.29               \\
Sz98     & 17   & 20.18               \\
V1094Sco & 16.7 & 21.57               \\ \hline
\end{tabular}
\caption{}
\label{tab:my-table}
\end{table}
