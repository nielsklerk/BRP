...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.5\linewidth]{All Spectra PRODIMO+FLITS 1.pdf}
    \caption{Caption}
    \label{fig:enter-label}
\end{figure}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\linewidth]{All Spectra PRODIMO+FLITS.pdf}
    \caption{Caption}
    \label{fig:enter-label}
\end{figure}
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\linewidth]{Figures/HCN_heatmap.pdf}
    \caption{Caption}
    \label{fig:enter-label}
\end{figure}
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\linewidth]{Figures/NO_heatmap.pdf}
    \caption{Caption}
    \label{fig:enter-label}
\end{figure}
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\linewidth]{Figures/NH3_heatmap.pdf}
    \caption{Caption}
    \label{fig:enter-label}
\end{figure}
\begin{figure}[!ht]
