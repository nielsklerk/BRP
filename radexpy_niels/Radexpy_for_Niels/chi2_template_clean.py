...
noise_est = 2e-3  # You can measure the noise by taking a line free region and taking the std of that, but 1 mJy is likely an okay estimate to start with
...
if __name__ == "__main__":
    ...
    tasks = [(i, N, j, Tgas) for i, N in enumerate(N_list) for j, Tgas in enumerate(Tgas_list)]
